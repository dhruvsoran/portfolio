          ...
          {certs.map((cert, i) => (
            ...
            >
              <div
                ...
                style={{ background: (issuerColors[cert.issuer] || '#10b981') + '15' }}
              >
                <svg className="w-5 h-5" style={{ color: issuerColors[cert.issuer] || '#10b981' }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs mt-0.5" style={{ color: issuerColors[cert.issuer] || '#10b981' }}>{cert.issuer}</p>
              </div>
            </motion.div>
          ))}
        </div>
